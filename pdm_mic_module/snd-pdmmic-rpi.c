 ...
 * =====================================================================================
 *
 *       Filename:  snd-pdmmic-rpi
 *
 *    Description:  PDM microphone kernel module
 *
 *        Version:  0.1.0
 *        Created:  2020-04-14
 *       Revision:  none
 ...
 */
void pdm_mic_rpi_exit(void)
{
  platform_device_unregister(&card_device);
  pr_alert("pdm mic module unloaded\n");
}

// Plumb it up
module_init(pdm_mic_rpi_init);
module_exit(pdm_mic_rpi_exit);
MODULE_DESCRIPTION("ASoC simple-card PDM Microphone");
